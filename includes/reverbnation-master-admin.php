...
if ( is_admin() )
add_menu_page( 'Reverbnation Master', 'Reverbnation Master', 'manage_options', 'reverbnation-master', 'reverbnation_master_admin', plugins_url( 'reverbnation-master/images/techgasp-minilogo-16.png' ) );
}
		///////////////////////
		// WORDPRESS ACTIONS //
		///////////////////////
...
if(!class_exists('reverbnation_master_admin_table_header')){
	require_once( dirname( __FILE__ ) . '/reverbnation-master-admin-table-header.php');
}
...
if(!class_exists('reverbnation_master_admin_table_news')){
	require_once( dirname( __FILE__ ) . '/reverbnation-master-admin-table-news.php');
}
//Prepare Table of elements
...
<?php
if(!class_exists('reverbnation_master_admin_table_support')){
	require_once( dirname( __FILE__ ) . '/reverbnation-master-admin-table-support.php');
}
//Prepare Table of elements
$wp_list_table = new reverbnation_master_admin_table_support();
//Table of elements
$wp_list_table->display();
